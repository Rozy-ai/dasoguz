                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <ul class="nav-pills nav-stacked nav">
                                <li><a href="<?=url::to('/profile')?>">Account details</a></li>
                                <li><a href="<?=url::to('/profile?view=update-account')?>">Account details</a></li>
                                <li><a href="<?=url::to('/profile?view=update-profile')?>">Profile details</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
