...
$category = \common\models\wrappers\CategoryWrapper::find()->where(['code' => 'contacts'])->one();
$catId = $category->id;
$contacts = \common\models\wrappers\ItemWrapper::find()->with(['translations','documents'])->where(['category_id' => $catId])->one(); 
?>
