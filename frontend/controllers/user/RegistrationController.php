...
//            yii::$app->params['username'] = yii::$app->request->post('username');
//            yii::$app->params['password'] = yii::$app->request->post('password');
//            var_dump(  yii::$app->request->post('username'));die;
//        }
        ...
        if ($model->load(\Yii::$app->request->post()) && $model->register()) {
            ...
            return $this->render('/messageRegistered', [
