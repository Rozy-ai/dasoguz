jQuery.fn.calendarPicker = function (options) {
  ...
  divWrapper.append(divMonths).append(divDays);
  theDiv.append(divYears).append(divWrapper);
  ...
  calendar.changeDate = function (date) {
    ...
    var fillMonths = function (date) {
      ...
      var t = new Date();
      divMonths.empty();
      var divMonthInner = $("<div>").addClass("divMonthInner");
      ...
      for (var i = -options.months; i <= options.months; i++) {
        ...
        if (d.getYear() == calendar.currentDate.getYear() && d.getMonth() == calendar.currentDate.getMonth())
          span.addClass("selected");
        divMonthInner.append(span);
      }

      divMonths.append(divMonthInner);
    }
    ...
    var fillDays = function (date) {
      ...
      var t = new Date();
      divDays.empty();
      var divDaysInner = $("<div>").addClass("calDayInner");
      ...
      for (var i = -options.days; i <= options.days; i++) {
        ...
        divDaysInner.append(span);
      }
      divDays.append(divDaysInner);
    }
