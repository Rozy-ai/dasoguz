...
class LoginForm extends Model {
    const SCENARIO_REST_LOGIN = 'rest_login';
    ...
    public function scenarios() {
        ...
        $scenarios[self::SCENARIO_REST_LOGIN] = ['login', 'password'];
        return $scenarios;
    }
...
//            [['reCaptcha'], \himiklab\yii2\recaptcha\ReCaptchaValidator::className(), 'secret' => Yii::$app->reCaptcha->secret, 'uncheckedMessage' => 'Please confirm that you are not a bot.', 'on' => self::SCENARIO_DEFAULT]
        ];
