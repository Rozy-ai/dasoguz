...
$script = <<< JS
      ...
      function initMap() {
            ...
            var lat=$('#middlepointwrapper-latitude').val() || 37.9309625;
            var lng=$('#middlepointwrapper-longitude').val() || 58.3874814;
            // if($('#middlepointwrapper-latitude').val()){
              $('#map').show();
      ...
      function geocodeByLocation(lat, lng){
        ...
        function updateInfoWindowByPlaceId(placeId, defaultValue){
           //  var lat=$('#middlepointwrapper-latitude').val();
           //  var lng=$('#middlepointwrapper-longitude').val();
           //  if(lat && lng){
        ...
        function updateFormInputs(lat, lng) {
            if(lat && lng){
              $('#middlepointwrapper-latitude').val(lat);
              $('#middlepointwrapper-longitude').val(lng);
             }
