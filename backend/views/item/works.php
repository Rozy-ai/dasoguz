...
<div class="item-wrapper-index">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Create Item Wrapper'), ['add-work', 'id' => $id], ['class' => 'btn btn-success']) ?>
    </p>
...
//            'user_id',
            ...
            [
                ...
                'template' => '{update} {delete-work} {crop}',
                ...
                'buttons' => array(
                    ...
                    'delete-work' => function($url, $model, $key) {     // render your custom button
                        ...
                        return Html::a('',$url.'&idc='.$model->user_id,['class' => 'glyphicon glyphicon-remove']);
                    },
                ),
                'options' => ['width' => '120'],
            ],
